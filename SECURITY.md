...
If you believe you've found a security vulnerability in Big7Construction, please **do not file a public GitHub issue**. Public disclosure puts users at risk before a fix is available.

Instead, report privately via:

- **Email:** murillomartinezmichael@gmail.com
- **Subject:** `[security] Big7Construction — short description`
